...
SET options=-Os -ffreestanding -Wall -Wextra -fno-exceptions -fno-rtti -I./include -DKERNEL_GIT_TAG=%version%
...
x86_64-elf-g++ %options% -T linker.ld -o kernel.bin kernel.o tty.o interrupts.o apic.o e820.o acpi.o -nostdlib -nodefaultlibs -nostartfiles -nostdinc
