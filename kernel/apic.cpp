...
void setupApic() {
	...
	apicBase[APIC_LVT_LINT0] = APIC_DISABLE;
	apicBase[APIC_LVT_LINT1] = APIC_DISABLE;
	...
	currentCount = apicBase[APIC_INITIAL_COUNT_REGISTER];
	...
	currentCount = apicBase[APIC_CURRENT_COUNT_REGISTER];
	kprintf("currentcount %08x",currentCount);
